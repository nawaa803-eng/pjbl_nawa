...
with st.sidebar:
    ...
    st.caption("Dibuat dengan :fire: oleh **Egel Mutazam Munawa**")
...
match pilihan:
    ...
    case "Layang-Layang":
        ...
        st.markdown("Menghitung `luas` dan `keliling` layang-layang")

        diagonal1 = st.number_input("Masukkan Diagonal 1", min_value=0.0)
        diagonal2 = st.number_input("Masukkan Diagonal 2", min_value=0.0)

        sisi_a = st.number_input("Masukkan Sisi A", min_value=0.0)
        sisi_b = st.number_input("Masukkan Sisi B", min_value=0.0)
